...
\usepackage{bbding} %Star separation
\usepackage{calc}
% \rmfamily
...
\begin{wrapfigure}{r}{0.65\textwidth}
	...
	\vspace{-20pt}
\end{wrapfigure}
final act were shattered when the \emph{Ober-Inspector} returned and said to 
me: "\emph{Regierungsrath} Funke is so particular that I would not dare to give an order for placing this 
